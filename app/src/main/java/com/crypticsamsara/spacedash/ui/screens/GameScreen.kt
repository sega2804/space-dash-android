    ...
    Box(
            ...
            Column(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        tint = if (gameState.currentAmmo > 10) NeonCyan else DangerRed,
                        modifier = Modifier.size(20.dp)
                    )
                    Spacer(modifier = Modifier.width(8.dp))
                    Text(
                        text = "${gameState.currentAmmo} / ${gameState.maxAmmo}",
                        color = if (gameState.currentAmmo > 10) StarWhite else DangerRed,
                        fontSize = 18.sp,
                        fontWeight = FontWeight.Bold
                    )
                }
        ...
        if (!gameState.isPlaying && gameState.isGameOver) {
            ...
            GameOverScreen(
                ...
                obstacleDodged = gameState.obstaclesDodged,
